...
class Spaceship(GameObject):
    ...
    def accelerate(self, reversed=False):
        # Maximum speed
        max_speed = 10  # Example: Maximum speed value

        acceleration = self.ACCELERATION  # Example: Set your acceleration value
        ...
        # Check if the velocity vector has a non-zero length
        if self.velocity.length() > 0:
            # Normalize the velocity vector and limit its length to the maximum speed
